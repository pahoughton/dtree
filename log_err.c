...
*	Notes:
*		
*	Programmer:		SQL Solutions - Paul Houghton (pah)
*
*	Start Date:		7-29-1991
*
*	Modification History:
*
*		10-15-1991	converted to ansi c (pah)
*
*	$Log$
*	Revision 1.1  1999/05/12 18:59:23  houghton
*	Initial Version.
*	
 * Revision 1.1  1992/01/01  20:49:58  paulh
 * Initial revision
 *
*
*********************************************************************/
...

{
	...
	char		err_num_str[10];		/* buffer for error number */
	
	int			msg_len;				/* current length of error message */
...
strncat(err_msg,in_msg,sizeof(err_msg) - (strlen(err_msg) + 2));	err_msg[sizeof(err_msg) - 2] = 0;
